...
def detect_scenes(resource_manager: ResourceManager, threshold: float = 30.0, min_scene_length: int = 15) -> List[Dict[str, Any]]:
    """
...
class SceneDetectionTool(BaseTool):
    ...
    def execute(cls, threshold: float = 30.0, min_scene_length: int = 15) -> List[Dict[str, Any]]:
        return detect_scenes(resource_manager, threshold, min_scene_length)